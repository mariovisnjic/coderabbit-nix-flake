      ...
      let
        ...
        sources = {
          ...
          "aarch64-linux" = {
            ...
            hash = "sha256-yyqkpZj6sWfNxkZ/CkS+UEhXzJhmBXvZTqcBhIGTfF0=";
          };
          "x86_64-darwin" = {
            platform = "darwin-x64";
            hash = "sha256-H1TqOG6fbvUncQHVT6bwca9l+IqACnhsb4OXY5autyc=";
          };
          "aarch64-darwin" = {
            platform = "darwin-arm64";
            hash = "sha256-KZRGZUKHIOVaompFLo9jeFhgenb0ciyruIKW9pdu5bc=";
          };
        };
